...
__kustomize_handle_go_custom_completion()
{
    ...
    # Calling ${words[0]} instead of directly kustomize allows to handle aliases
    args=("${words[@]:1}")
...
_kustomize_build()
{
    ...
    flags+=("--enable-star")
    local_nonpersistent_flags+=("--enable-star")
    flags+=("--env=")
    two_word_flags+=("--env")
    two_word_flags+=("-e")
...
_kustomize_fn_run()
{
    ...
    local_nonpersistent_flags+=("--results-dir=")
    flags+=("--star-name=")
    two_word_flags+=("--star-name")
    local_nonpersistent_flags+=("--star-name")
    local_nonpersistent_flags+=("--star-name=")
    flags+=("--star-path=")
    two_word_flags+=("--star-path")
    local_nonpersistent_flags+=("--star-path")
    local_nonpersistent_flags+=("--star-path=")
    flags+=("--star-url=")
    two_word_flags+=("--star-url")
    local_nonpersistent_flags+=("--star-url")
    local_nonpersistent_flags+=("--star-url=")
    flags+=("--stack-trace")
...
_kustomize_fn_sink()
{
    last_command="kustomize_fn_sink"
...
{
    last_command="kustomize_fn_source"
    ...
    flags+=("--function-config=")
    two_word_flags+=("--function-config")
    flags_with_completion+=("--function-config")
    flags_completion+=("__kustomize_handle_filename_extension_flag yaml|json|yml")
    local_nonpersistent_flags+=("--function-config")
    local_nonpersistent_flags+=("--function-config=")
    flags+=("--wrap-kind=")
    two_word_flags+=("--wrap-kind")
...
_kustomize_fn_wrap()
{
    last_command="kustomize_fn_wrap"
    ...
    flags+=("--env-only")
    local_nonpersistent_flags+=("--env-only")
    flags+=("--wrap-kind=")
    two_word_flags+=("--wrap-kind")
    local_nonpersistent_flags+=("--wrap-kind")
    local_nonpersistent_flags+=("--wrap-kind=")
...
_kustomize_fn_xargs()
{
    last_command="kustomize_fn_xargs"
